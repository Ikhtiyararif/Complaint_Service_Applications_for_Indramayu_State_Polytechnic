...
<div class="container">
    <nav id="nav" class="fixed shadow inset-x-0 top-0 flex flex-row justify-between items-center z-10 bg-white text-white px-8 py-6 md:px-28 md:py-8">
        ...
        <div class="hidden md:flex flex-row justify-between items-center">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="/arsiplaporan"><i class="fa-regular fa-folder-closed"></i> Arsip Laporan</a></li>
